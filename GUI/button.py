...
class Button:
    def __init__(self, text, game, font, category, coords=None):
        ...
        if(coords):
            ...
            self.buttonCountControlMenu = game.buttonCountControlMenu
            self.currCountControlMenu = game.currCountControlMenu +1
            game.currCountControlMenu +=1
            self._setCoords(self.buttonCountControlMenu, self.currCountControlMenu)
